...
test("string literals", function() {
    equal('franken' + 'stein', "frankenstein", "quote types are interchangable, but must match.");
    equal("franken" + 'stein', 'frankenstein', "quote types can use both single and double quotes.");
});
